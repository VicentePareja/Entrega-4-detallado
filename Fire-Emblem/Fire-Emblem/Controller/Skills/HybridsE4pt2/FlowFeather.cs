...
public class FlowFeather: Skill
{
    private Character _owner;
    private Character _opponent;
    private Combat _combat;
    
    public FlowFeather(string name, string description) : base(name, description)
    {
    }
    ...
    {
        double dmgAlteration = (_owner.GetEffectiveAttribute("Res") - _opponent.GetEffectiveAttribute("Res")) * 0.7;
